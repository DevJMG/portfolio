...
import { SiHtml5, SiCss3, SiJavascript, SiJquery, SiReact, SiTailwindcss, SiBootstrap, SiGithub, SiPhp, SiMysql, SiAdobephotoshop, SiAdobeillustrator, SiFigma, SiNpm } from 'react-icons/si';
                ...
                <div className='max-w-[1240px] h-full mx-auto'>
                    <div className='w-full flex flex-row flex-wrap justify-center items-center pt-5 pb-10 md:pb-0'>
                        ...
                        <div className='md:w-1/2 w-full flex flex-col justify-center text--dark--gray md:pb-10 pb-0'>
                            ...
                            <p className='pb-3'>A <b>Freelance Front-End Web Developer</b> based in the Philippines.</p>
                            <p className='pb-3'>I'm passionate in crafting web applications that are scalable and efficient while providing engaging and pixel-perfect user experiences through modern technologies and apporach.</p>
                            ...
                            <div className='mx-auto md:mx-0 my-2'>
                                <a href={cv} target='blank' rel='noreferrer'>
                                {<Button
                    ...
                    <div className='w-full pt-5 pb-10'>
                        ...
                        <div className='w-full flex flex-row flex-wrap justify-center items-center'>
                            <Card
                                ...
                                description={`I'm having an interest in responsiveness and making web applications I build look good on various screen sizes using both Mobile First approach and desktop Media Queries.`}
                            ></Card>
