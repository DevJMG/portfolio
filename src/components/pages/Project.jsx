        ...
        <div id='project-section' className='project--section w-full h-full px-10 py-16'>
            <div className='max-w-[1240px] h-full mx-auto'>
                <div className='w-full py-5'>
                    ...
                    type='Web-based App'
                    description={`
                    QMS is used to monitor and manage the quizzes of the learners. It was developed using Bootstrap to make responsive design, and JQuery to create dynamic content.
                    `}
                    tag1='JQuery'
                    tag2='Bootstrap'
                    image={Project2}
